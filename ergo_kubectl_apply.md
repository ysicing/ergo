...
```
ergo kubectl apply (-f FILENAME | -k DIRECTORY)
```
...
* [ergo kubectl apply edit-last-applied](ergo_kubectl_apply_edit-last-applied.md)	 - Edit latest last-applied-configuration annotations of a resource/object
* [ergo kubectl apply set-last-applied](ergo_kubectl_apply_set-last-applied.md)	 - Set the last-applied-configuration annotation on a live object to match the contents of a file
* [ergo kubectl apply view-last-applied](ergo_kubectl_apply_view-last-applied.md)	 - View the latest last-applied-configuration annotations of a resource/object
