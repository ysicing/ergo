...
* [ergo kubectl config delete-cluster](ergo_kubectl_config_delete-cluster.md)	 - 删除 kubeconfig 文件中指定的集群
* [ergo kubectl config delete-context](ergo_kubectl_config_delete-context.md)	 - 删除 kubeconfig 文件中指定的 context
* [ergo kubectl config delete-user](ergo_kubectl_config_delete-user.md)	 - Delete the specified user from the kubeconfig
* [ergo kubectl config get-clusters](ergo_kubectl_config_get-clusters.md)	 - 显示 kubeconfig 文件中定义的集群
* [ergo kubectl config get-contexts](ergo_kubectl_config_get-contexts.md)	 - 描述一个或多个 contexts
...
* [ergo kubectl config view](ergo_kubectl_config_view.md)	 - 显示合并的 kubeconfig 配置或一个指定的 kubeconfig 文件
