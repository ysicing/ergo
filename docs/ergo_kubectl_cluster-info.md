...
```
ergo kubectl cluster-info [flags]
```
...
* [ergo kubectl cluster-info dump](ergo_kubectl_cluster-info_dump.md)	 - Dump relevant information for debugging and diagnosis
