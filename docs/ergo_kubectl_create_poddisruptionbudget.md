## ergo kubectl create poddisruptionbudget
...
```
ergo kubectl create poddisruptionbudget NAME --selector=SELECTOR --min-available=N [--dry-run=server|client|none]
```
...
```
  ...
  -h, --help                           help for poddisruptionbudget
      ...
      --min-available string           最小数量百分比可用的 pods 作为 budget 要求.
