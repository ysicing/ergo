...
wget -O /tmp/helm-linux-amd64.tar.gz https://get.helm.sh/helm-v3.8.2-linux-amd64.tar.gz
wget -O /tmp/helm-linux-arm64.tar.gz https://get.helm.sh/helm-v3.8.2-linux-arm64.tar.gz
...
echo "fetch k3s"
wget -O ./hack/bin/k3s-linux-amd64 https://github.com/k3s-io/k3s/releases/download/v1.23.6%2Bk3s1/k3s
wget -O ./hack/bin/k3s-linux-arm64 https://github.com/k3s-io/k3s/releases/download/v1.23.6%2Bk3s1/k3s-arm64
...
wget -O /tmp/cilium-linux-amd64.tar.gz https://github.com/cilium/cilium-cli/releases/latest/download/cilium-linux-amd64.tar.gz
tar xzvfC /tmp/cilium-linux-amd64.tar.gz /tmp
mv /tmp/cilium ./hack/bin/cilium-linux-amd64
wget -O /tmp/cilium-linux-arm64.tar.gz https://github.com/cilium/cilium-cli/releases/latest/download/cilium-linux-arm64.tar.gz
